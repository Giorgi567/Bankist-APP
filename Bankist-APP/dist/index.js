...
const calculateTotal = function (acc) {
...
let currentAcc; // variable that lets me know which account is currently open on the website
...
btnLogin.addEventListener("click", function (e) {
    ...
    if ((currentAcc === null || currentAcc === void 0 ? void 0 : currentAcc.username) === inputLoginUsername.value &&
    ...
    inputLoginPin.value = "";
    labelWelcome.textContent = `Welcome ${currentAcc === null || currentAcc === void 0 ? void 0 : currentAcc.owner}`;
});
...
btnClose.addEventListener("click", function (e) {
    ...
    Number(inputClosePin.value) === (currentAcc === null || currentAcc === void 0 ? void 0 : currentAcc.pin) &&
        inputCloseUsername.value === (currentAcc === null || currentAcc === void 0 ? void 0 : currentAcc.username)) {
        const targetAccount = accounts.findIndex((acc) => {
            // finding the index of the account we want to delete from the array
            return (acc.username === (currentAcc === null || currentAcc === void 0 ? void 0 : currentAcc.username) && acc.pin === (currentAcc === null || currentAcc === void 0 ? void 0 : currentAcc.pin));
        });
